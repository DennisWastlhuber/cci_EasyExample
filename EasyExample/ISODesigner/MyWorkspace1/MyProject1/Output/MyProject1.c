...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 9, 0, 
		...
		XYREF(Button_Minus, 196, 418),
		XYREF(InputNumber_Tagesziel, 16, 430),
	...
	ID(Button_Minus), TYPEID_BUTTON, WORD(106), WORD(49), 187, 144, 1, 0, 1, 0, 
		XYREF(OutputString_11006, -4, 11),
	ID(InputNumber_Tagesziel), TYPEID_INNUM, WORD(68), WORD(34), COLOR(187), ID(FontAttributes_Default), 0, 
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(80), WORD(40), COLOR_WHITE, ID(FontAttributes_Button), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(106), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(4), '-', '-', ' ', ' ', 0,
	ID(OutputString_11007), TYPEID_OUTSTR, WORD(61), WORD(36), COLOR_WHITE, ID(FontAttributes_Default), 1,
		ID(ID_NULL), 1, WORD(4), '-', '-', ' ', ' ', 0,
